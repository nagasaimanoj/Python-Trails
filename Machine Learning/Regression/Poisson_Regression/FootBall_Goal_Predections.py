...
if __name__ == "__main__":
    football_match_data = read_csv(dirname(__file__) + "\\" + "E0.csv")[[
        'FTHG', 'FTAG'
    ]]

    hist(
        football_match_data.values,
        range(10),
        normed=True,
        color=['#77AA77', '#AAAAAA'],
        label=['Home', 'Away'])
    ...
    plot(
        football_match_x_axis,
        poisson.pmf(range(10),
                    football_match_data.mean()[0]),
        marker='o',
        label="Home",
        color='#FF88c0')
